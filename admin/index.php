    ...
    <div class="col-12 tm-block-col mt-5">
        <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-scroll">
            <div class="row">
                ...
                <span class="tm-block-title col-md-4">ORDER LIST PENDING</span>
                <span class="tm-block-title col-md-3"></span>
            </div>
            <div class="row">
                <h2 class="tm-block-title col-md-3"><a class="btn btn-primary" href="index.php" style="background-color: #23cef5;border: 2px solid #23cef5;">1. Orders List
                        Pending</a></h2>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                                    if ($result['statusId'] == 0) {
                                                        ?>
                                            </div><a onclick ="return confirm('Bạn có muốn MOVING không??')" href='?orderid=<?php echo $result['id'] ?>&price=<?php echo $result['price'] ?>&date=<?php echo $result['date'] ?>' style='color:#efc54b;'>Pending</a>
                                        <?php
                                                    } ?>
                                    ...
                                    <td><b><a href="custumerView.php?custumerid=<?php echo $result['custumerId'] ?>">View
                                                Account</a></b></td>
                                    <td>
                                        <a class="btn btn-danger" onclick ="return confirm('Bạn có muốn CANCELLED đơn hàng này không??')" href='?cancelid=<?php echo $result['id'] ?>&price=<?php echo $result['price'] ?>&date=<?php echo $result['date'] ?>&cancel=cancel'>Cancel</a>
                                    </td>
                                </tr>
                    <?php
                            }
