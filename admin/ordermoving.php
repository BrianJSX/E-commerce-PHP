        ...
        <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-scroll">
            ...
            <div class="row">
                <h2 class="tm-block-title col-md-3"><a class="btn btn-primary" href="index.php">1. Orders List
                        Pending</a></h2>
                <h2 class="tm-block-title col-md-3"><a style="background-color: #23cef5;border: 2px solid #23cef5;" class="btn btn-primary" href="ordermoving.php">2. Orders List
                        Moving</a></h2>
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th scope="col">CANCELED PRODUCT</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            if ($result['statusId'] == 1) {
                                        ?>
                                            <div class='tm-status-circle moving'></div><a onclick ="return confirm('Đơn Hàng Sẽ Được COMPLETE Ngay Bây Giờ???')" href='?completeid=<?php echo $result['id'] ?>&price=<?php echo $result['price'] ?>&date=<?php echo $result['date']?>&complete=complete' style='color:#9be64d;'>Moving</a>
                                    ...
                                    <td>
                                        <a onclick ="return confirm('Đơn Hàng Sẽ Được CANCEL Ngay Bây Giờ??')" href='?cancelid=<?php echo $result['id'] ?>&price=<?php echo $result['price'] ?>&date=<?php echo $result['date'] ?>&cancel=cancel' class="btn btn-danger">Cancel</a>
                                    </td>
                                </tr>
                    <?php
                            }
